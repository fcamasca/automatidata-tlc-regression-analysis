...
| | |
|---|---|
| ![Análisis – EDA (Duración del viaje)](dashboards/Tableau/Análisis–EDA(Duración-del-viaje).png) | ![Análisis–EDA (Distancia vs duración)](dashboards/Tableau/Análisis–EDA-(Distancia-vs-duración).png) |
| ![Construcción – Feature Insights (Rush hour)](dashboards/Tableau/Construcción–Feature-Insights-(Rush-hour).png) | ![Dashboard Tableau](dashboards/Tableau/Dashboard.png) |
...
| | |
|---|---|
| ![Análisis Analítico de Tarifas](dashboards/PowerBI/Análisis-Analítico-de-Tarifas.jpg) | ![Evaluación del Modelo de Regresión](dashboards/PowerBI/Evaluación-del-Modelo-de-Regresión.jpg) |
